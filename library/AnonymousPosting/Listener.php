...
class AnonymousPosting_Listener
{
	...
	public static function load_class_XenForo_ControllerPublic_Thread($class, array &$extend)
	{
		...
		{
			$extend[] = 'AnonymousPosting_ControllerPublic_Thread';
			
			// returning false should not cause a problem here because we have 9999 execution order
			// and we must be the last one in the chain so...
			// if this cause issue, it's a pretty big conflict
			// please contact developer: pony@xfrocks.com
			return false;
		}
	}
