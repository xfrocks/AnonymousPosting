...
// updated by DevHelper_Helper_ShippableHelper at 2016-08-12T06:02:24+00:00

/**
 * Class AnonymousPosting_ShippableHelper_Updater
 * @version 7
...
class AnonymousPosting_ShippableHelper_Updater
{
    ...
    public static function onInitDependencies(
        ...
        $GLOBALS[self::KEY]['version'][$apiUrl][self::$_version]
            = 'AnonymousPosting_ShippableHelper_UpdaterCore';
    ...
    public static function onUninstall($apiUrl = null, $addOnId = null)
    {
        ...
        if (empty($activeAddOnIds)) {
            ...
            AnonymousPosting_ShippableHelper_UpdaterCore::_uninstallSelf($apiUrl);
        }
    }
